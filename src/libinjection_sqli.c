...
static size_t parse_number(struct libinjection_sqli_state *sf) {
     ...
     * From this Bolg, we could see 1.e or 1.E is a risk SQLI, The SQL parser
     * will ignore it during parsing. Like "1.e(1)" => (1), 1 1.e/1 => 1/1 etc.
     * So, if a payload such as "1' or 1.e(1)" bypass SQLI detection, which is
     * really risk, we should detect such SQLI injection in case WAF bypass.
     */
